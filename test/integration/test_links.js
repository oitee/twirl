...
async function testLinkShortening() {
  ...
  let longLinkObject_1 = await expandLink(user1_ID, shortLink1_byUser1);
  assert(
  ...
  let longLinkObject_1_user_2 = await expandLink(user2_ID, shortLink1_byUser1);
  assert.equal(
  ...
  // EXPAND SHORT LINK1 BY USER2
  //----------------------------------------------------------------
  longLinkObject_1_user_2 = await expandLink(user2_ID, shortLink1_byUser2);
  assert.equal(
    longLinkObject_1_user_2.status,
    true,
  ...
  let longLinkObject_2 = await expandLink(user1_ID, shortLink2);
  assert(
